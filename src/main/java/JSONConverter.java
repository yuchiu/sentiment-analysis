...
public class JSONConverter {
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("/home/rainman/Documents/sentiment-analysis/output/part-r-00000"));
        String line = br.readLine();
        FileWriter fileWriter = new FileWriter("/home/rainman/Documents/sentiment-analysis/output/result.json");
